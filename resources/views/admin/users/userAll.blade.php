...
<div class="wrapper">
  	...
  	<div class="content-wrapper">
		<section class="content">
			...
			<!-- end message json>? -->
			<h3>User Lists <i class="fa fa-angle-double-right"></i> <a href="{{route('getcreateUser')}}" class="btn btn-primary btn-xs">Add New</a></h3>	
		        ...
		        <tbody>
		            ...
		            <tr>
		            	...
		            	<td style="width: 80px;" class="text-right">		            		
				    		...
				    		<a data-action="user" data-id="{{$user->id}}" class="btnDelete btn btn-danger btn-xs">Delete</a>
				    		@endif
		            	</td>
		            </tr>
		            @endforeach
